...
{
    /// <inheritdoc />
    public partial class AddLabelsAndNoteLabelsTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NotesLabels", x => x.NoteLabelId);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_NotesLabels_Notes_NoteId",
                        column: x => x.NoteId,
